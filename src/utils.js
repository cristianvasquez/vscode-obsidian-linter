 ...
 */
function replaceCodeblocks (text, placeholder) {
  const positions = getPositions('code', text)
 ...
 */
export function moveFootnotesToEnd (text) {
  const positions = getPositions('footnoteDefinition', text)
  const footnotes = []
 ...
 * @param {function(string)} func - The function to apply to the text
 * @return {string} The processed text
 */
export function ignoreCodeBlocksAndYAML (text, func) {
...
export function formatYAML (text, func) {
...
export function escapeDollarSigns (str) {
...
export function loadYAML (yaml_text) {
  const parsed_yaml = load(yaml_text)
